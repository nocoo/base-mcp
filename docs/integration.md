# MCP integration and API examples

These examples show the integration shape. The host application supplies its HTTP framework, data layer, sessions and token store; placeholder application functions must be implemented by the consumer.
